			...
			>
				...
				<div>
					<h1 className={`${styles.heroHeadText} text-white relative z-10`}>
						Halo aku <span className='text-clr_blue'>Cipa</span>
					</h1>
					<p
						className={`${styles.heroSubText} relative z-10 mt-2 text-white-100 md:max-w-[640px] max-w-[460px] `}
					>
						Biasa di panggil put, puput, mput, cipa <br />Belajar ngoding sejak masuk SMK 
						kelas 10&nbsp;di SMK Purnawarman Purwakarta
					</p>
				</div>
			</div>
